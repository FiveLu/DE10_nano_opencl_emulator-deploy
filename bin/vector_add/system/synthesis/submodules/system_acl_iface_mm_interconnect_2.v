...
module system_acl_iface_mm_interconnect_2 (
	...
	wire         cmd_mux_src_valid;                                                          // cmd_mux:src_valid -> acl_kernel_interface_ctrl_agent:cp_valid
	wire  [85:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> acl_kernel_interface_ctrl_agent:cp_data
	wire         cmd_mux_src_ready;                                                          // acl_kernel_interface_ctrl_agent:cp_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> acl_kernel_interface_ctrl_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                  // cmd_mux:src_startofpacket -> acl_kernel_interface_ctrl_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                    // cmd_mux:src_endofpacket -> acl_kernel_interface_ctrl_agent:cp_endofpacket
	...
	wire         cmd_mux_001_src_valid;                                                      // cmd_mux_001:src_valid -> version_id_s_agent:cp_valid
	wire  [85:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> version_id_s_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                      // version_id_s_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [1:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> version_id_s_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                              // cmd_mux_001:src_startofpacket -> version_id_s_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                // cmd_mux_001:src_endofpacket -> version_id_s_agent:cp_endofpacket
	...
	wire         acl_kernel_interface_ctrl_agent_rp_valid;                                   // acl_kernel_interface_ctrl_agent:rp_valid -> router_001:sink_valid
	wire  [85:0] acl_kernel_interface_ctrl_agent_rp_data;                                    // acl_kernel_interface_ctrl_agent:rp_data -> router_001:sink_data
	wire         acl_kernel_interface_ctrl_agent_rp_ready;                                   // router_001:sink_ready -> acl_kernel_interface_ctrl_agent:rp_ready
	wire         acl_kernel_interface_ctrl_agent_rp_startofpacket;                           // acl_kernel_interface_ctrl_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire         acl_kernel_interface_ctrl_agent_rp_endofpacket;                             // acl_kernel_interface_ctrl_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [85:0] version_id_s_agent_rp_data;                                                 // version_id_s_agent:rp_data -> router_002:sink_data
	...
	wire         acl_kernel_interface_ctrl_agent_rdata_fifo_src_valid;                       // acl_kernel_interface_ctrl_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] acl_kernel_interface_ctrl_agent_rdata_fifo_src_data;                        // acl_kernel_interface_ctrl_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         acl_kernel_interface_ctrl_agent_rdata_fifo_src_ready;                       // avalon_st_adapter:in_0_ready -> acl_kernel_interface_ctrl_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                              // avalon_st_adapter:out_0_valid -> acl_kernel_interface_ctrl_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                               // avalon_st_adapter:out_0_data -> acl_kernel_interface_ctrl_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                              // acl_kernel_interface_ctrl_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                              // avalon_st_adapter:out_0_error -> acl_kernel_interface_ctrl_agent:rdata_fifo_sink_error
	wire         version_id_s_agent_rdata_fifo_src_valid;                                    // version_id_s_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] version_id_s_agent_rdata_fifo_src_data;                                     // version_id_s_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         version_id_s_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_001:in_0_ready -> version_id_s_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                          // avalon_st_adapter_001:out_0_valid -> version_id_s_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                           // avalon_st_adapter_001:out_0_data -> version_id_s_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                          // version_id_s_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                          // avalon_st_adapter_001:out_0_error -> version_id_s_agent:rdata_fifo_sink_error
